<div class="row mb-5">
    <div class="col-4">
        <button class="bg-transparent border-0 shadow-none p-0 d-block mx-auto" data-bs-toggle="modal" data-bs-target="#recent-comments{{$user->id}}">
            @if($user->avatar)
       ...
       @include('user.profiles.modal.comment')
    </div>
